...
<body>
    ...
    <header class="header header--mod header--marginLess">
        <p class="header__title header__title--smaller">
            THE ULTIMATE LUXURY
        </p>
        <p class="header__title header__title--mod header__title--mod2">
            New Details
        </p>
    ...
    <section class="formData">
        <h1 class="features__container__number features__container__number--light features__container__number--1">
            01
        </h1>
        <h1 class="features__container__number features__container__number--light features__container__number--2">
            02
        </h1>
        <h1 class="features__container__number features__container__number--light features__container__number--3">
            03
        </h1>
        <div class="footer__contactData footer__contactData--mod">
            <div>
    ...
    <section class="formSection">
        ...
        <form>
            ...
            <button type="submit" class="aboutUs__description__button aboutUs__description__button--marginLess">SEND</button>
        </form>
    </section>
    <footer class="footer">
